...
public class Form { //Проверки анкеты
    ...
    private By resultEmail=By.cssSelector("#dataTable > tbody > tr > td:nth-child(1)"); // Поле емэйл в таблице
    ...
    public void fillFormNoEmailSymbols() {
    ...
    public void fillFormEmailWrongFormat()  {
    ...
    public void fillFormEmailShort()  {
